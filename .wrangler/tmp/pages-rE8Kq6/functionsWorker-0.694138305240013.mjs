// ../.wrangler/tmp/bundle-PRmp1i/checked-fetch.js
...
// ../lib/const.ts
var MBC_URL = "https://imnews.imbc.com/replay";

// ../lib/index.ts
var getMBCArticles = async (date) => {
  try {
    ...
    fetch(calendar).then((res) => {
      ...
      const calJson = JSON.parse(calText2);
      console.log(calJson);
    });
...
var onRequestGet = async (context) => {
  ...
  const res = await getMBCArticles(date);
  return res ? new Response(JSON.stringify(res)) : new Response("failed");
};
...
// ../.wrangler/tmp/pages-rE8Kq6/functionsRoutes-0.08684463544345045.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-PRmp1i/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-PRmp1i/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.694138305240013.mjs.map
